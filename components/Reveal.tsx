        ...
        <div className="flex flex-col items-center justify-center flex-1 p-4 w-full">
            ...
            >
                ...
                <button
                    ...
                    className="w-full py-4 text-xl font-black text-white bg-game-blue border-b-8 border-game-blue-dark rounded-2xl hover:-translate-y-1 hover:border-b-[10px] active:border-b-0 active:translate-y-2 transition-all uppercase tracking-wider"
                >
                    Lanjut Gas! ⏭️
                </button>
            </motion.div>
